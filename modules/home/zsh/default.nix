  ...
  config = mkIf cfg.enable {
    programs.zsh = rec {
      ...
      sessionVariables = {
        ...
        BROWSER = "firefox";
        EDITOR = "${config.programs.emacs.finalPackage}/bin/emacsclient -tc";
      ...
      shellAliases = {
        ...
        e = "${config.programs.emacs.finalPackage}/bin/emacsclient -tca 'emacs -nw'";
        eg = "${config.programs.emacs.finalPackage}/bin/emacsclient -nce '(select-frame-set-input-focus (selected-frame))' > /dev/null";
        ek = "${config.programs.emacs.finalPackage}/bin/emacsclient -e '(kill-emacs)'";
